...
| 文件 | 行数 | 内容 |
|---|---|---|
| `SKILL.md` | 261 | 核心：三阶段协议（问需求 → 风格规格书 → 施工）、12 步施工、两道闸门、交付话术、脚本表 |
...
| `references/judge-prompt.md` | 88 | 闸门二视觉验收的 judge 填空模板（输出机器可读 JSON verdict） |
...
| `scripts/qa.py` | 1169 | 闸门一：几何 / 中文排版 / 对比度 / 交付合法性 / 表格外框裁剪 / 字体可移植性 / deck 级骨架 |
