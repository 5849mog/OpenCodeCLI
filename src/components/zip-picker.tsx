...
export function ZipPickerModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="w-full max-w-md rounded-xl border border-[#E5E2D9] bg-[#FFFFFF] p-4 shadow-2xl">
        <div className="mb-3 font-semibold">AI 请求解压 zip 文件</div>
        <p className="mb-3 text-sm text-[#6B6862]">
        ...
        {isStreaming ? (
          <p className="text-sm text-[#A8A29E]">Agent 仍在运行，请稍候…</p>
        ) : (
          <button
        ...
        <button
          ...
          className="mt-2 w-full rounded-lg border px-3 py-2 text-sm text-[#6B6862] hover:bg-gray-50"
        >
          取消
        </button>
      </div>
