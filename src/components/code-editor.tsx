...
const claudeTheme = EditorView.theme(
  {
    ...
    ".cm-panels": { backgroundColor: "#1c1a17", color: "#e7e5e4" },
    ".cm-panels input": { backgroundColor: "#161512", color: "#e7e5e4", border: "1px solid #3a3731" },
    ".cm-textfield": { backgroundColor: "#161512", color: "#e7e5e4" },
    ".cm-foldPlaceholder": { backgroundColor: "#3a3731", color: "#a1a1aa", border: "none" },
    ".cm-tooltip": { backgroundColor: "#1c1a17", border: "1px solid #3a3731", color: "#e7e5e4" },
